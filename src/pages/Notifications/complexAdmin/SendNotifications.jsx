      ...
      <Box className="my-4 py-4 px-6 rounded bg-bgLight drop-shadow-lg dark:bg-gradient-to-r dark:from-mainPrimary dark:to-mainSecondary w-full">
                  ...
                  <Form className="w-full flex flex-col gap-3">
                    <Box className="flex flex-col items-center">
                      <Box className="lg:flex w-full items-center">
                        <Typography className="font-semibold text-textDark2 dark:text-text2 text-[16px] mb-1 capitalize w-[30%] ">{t("Informing channel")}</Typography>
                        <Box className=" flex gap-8  px-2 w-[70%]">
                          ...
                          <FormControl component="fieldset" style={{ color: "#888" }}>
                            <FormControlLabel
                              value="end"
                              control={<Checkbox checked={check1} onChange={handleCheck1} />}
                              label={t("SMS Message")}
                              labelPlacement="end"
                              style={{ color: "#888" }}
                            />
                    ...
                    <Box>
                      {
                        check==true&&<Box className="flex flex-col gap-2 mt-3">
                      ...
                      {
                        check1==true&&<Box className="flex flex-col gap-3 mt-3">
                          <Box className=" mb-3 lg:flex h-auto w-full justify-between">
                            ...
                            <Typography className="w-full flex items-center dark:bg-[#256D85] bg-[#C9B26D] text-white dark:text-text1 text-sm rounded pl-3 py-1 lg:w-[70%]">
                              {t("For your information")} - {t("The number of characters for English letters is 160. The number of characters for Azerbaijani and Russian letters is 70.")}
                            </Typography>
                          </Box>
                              ...
                              />
                              {
                                focus&&
                                  <Box className="flex justify-center ">
                                    <Typography className="w-[250px] absolute flex items-center -m-8 dark:bg-[#256D85] bg-[#C9B26D] text-sm rounded text-white dark:text-text1 p-1 justify-center ">You typed {value.length} out of 160 charachters</Typography>
        ...
        <Box className="flex justify-between items-center gap-x-1 bg-bgLight dark:bg-[#404954] py-5 px-3 sm:px-6 rounded mt-2">
          <Link to="/notifications-archive">
                <Button
                startIcon={<Inventory2OutlinedIcon className="text-dark dark:text-white" />}
                variant="contained"
            ...
            <Box className="flex gap-3">
                <Button
                  ...
                  startIcon={<CheckCircleOutlineOutlinedIcon className="text-dark dark:text-white" />}
                >{t(["Submit"])}</Button>
            </Box>
        </Box>
