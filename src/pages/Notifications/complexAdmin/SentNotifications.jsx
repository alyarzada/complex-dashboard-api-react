    ...
    <Box className="w-full">
        ...
        <Box className="my-4 py-4 px-6 rounded bg-bgLight drop-shadow-lg dark:bg-gradient-to-r dark:from-mainPrimary dark:to-mainSecondary w-full">
          <Box className="flex justify-between">
            ...
            <Typography className=" text-textDark2 dark:text-text2 text-[16px] flex gap-1 items-center">SMS balance: <span className=" px-1 bg-sky-500 rounded text-white dark:text-text1">{rows.length}</span></Typography>
          </Box>
