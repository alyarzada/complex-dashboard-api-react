                    ...
                    {() => (
                        <Form className="w-full flex flex-col gap-3">    
                            ...
                            <Box className="lg:flex gap-3 w-full mt-3">
                                <Box className="w-full">
                                    <Typography className="flex items-center text-textDark2 dark:text-text2 text-[16px] mb-2 capitalize">Azərbaycan</Typography>
                                    <CustomTextField
                                ...
                                <Box className="w-full">
                                    <Typography className="flex items-center text-textDark2 dark:text-text2 text-[16px] mb-2 capitalize">English</Typography>
                                    <CustomTextField
                                        className="w-full mb-0"
                                        label={t(["English"])}
                                        name="date"
                                ...
                                <Box className="w-full">
                                    <Typography className="flex items-center text-textDark2 dark:text-text2 text-[16px] mb-2 capitalize">Русский</Typography>
                                    <CustomTextField
                                        className="w-full mb-0"
                                        label={t(["Русский"])}
                                        name="date"
                            ...
                            <Box className="mb-1 pl-3 flex items-center gap-3 py-4 px-6 rounded drop-shadow-lg dark:bg-[#404954] bg-[#C9B26D] dark:from-mainPrimarytext-white dark:text-text2 text-[16px] capitalize dark:to-mainSecondary w-full">
                                ...
                                >
                                    <CustomFile title={<span><CameraAltOutlined /> {t("Photo")}</span>}/> 
                                </Button>
                            </Box>
