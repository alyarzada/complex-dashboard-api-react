...
const PhotoEdit = () => {
  ...
  return (
    <Box>
      ...
      <Box className="my-4 p-5 rounded-xl  drop-shadow-lg bg-bgLight dark:bg-bgMain w-full">
        <Box className="mb-7 pl-3 flex items-center gap-3 py-3 px-6 rounded-xl drop-shadow-lg dark:bg-[#404954] bg-logoColor dark:from-mainPrimary text-white dark:text-text2 text-[16px] capitalize dark:to-mainSecondary w-full">
                ...
                {photoInputLabels.map((item) => {
                  return (
                    <Box className="w-full px-3 my-3 md:w-1/2">
                      ...
                      <Box className="flex  items-center rounded-xl  drop-shadow-lg bg-bgLight  dark:bg-bgMain font-semibold text-textDark2 dark:text-text2 text-[16px] mb-1 capitalize w-full">
