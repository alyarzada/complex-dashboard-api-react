...
import { Box, Button, Typography, Pagination, Input } from "@mui/material";
  ...
  return (
    <Box className="w-full">
      ...
      <Box className="my-4 py-4 px-6 rounded drop-shadow-lg  bg-bgLight dark:bg-bgMain w-full">
        <CustomSearchFilter hidden3={true} flex={true} />
        <Box className="w-full flex flex-col sm:flex-row justify-between">
          <Link to="/mtk-users/create">
            <Button
              variant="contained"
              startIcon={<AddCircleOutlinedIcon />}
              className="capitalize bg-rose-500 text-white mb-1"
            >
