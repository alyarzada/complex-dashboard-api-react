...
const FormModal = ({ modal }) => {
  ...
  const { mutate: mutateFormRequest } = useMutation({
    queryFn: sendFormRequest,
  });
  const { mutate: mutateCardRequest } = useMutation({
    queryFn: sendCardRequest,
  });
