                        ...
                        buttons.map((item)=>{
                            return(
                                <Button className="capitalize text-white flex justify-between w-full text-sm" >
                                    <Typography className={item.id==1?"text-[#fa515e] font-bold items-center":"text-white  items-center"}>
                                        {item.icon}  {item.title}
                                    </Typography> 
                                    <Typography className={item.id==1?"text-sm text-[#fa515e] font-bold items-center justify-center bg-[#fa515e11]":"text-sm text-white  items-center justify-center bg-[#fa515e11]"}>
                                        {item.count}
                                    </Typography>
                                </Button>
