...
import { reOrderPanels } from "../../app/Slicers/localStates/data";
  ...
  return (
    <Box className="mb-6">
      ...
      <ReactSortable
        ...
        className="select-none grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xxl:grid-cols-4 exl:grid-cols-6 gap-4"
        animation={400}
