    ...
    <Box className="w-full">
      ...
      {role_id === 2 ? (
        <Box>
            ...
            <Box className="w-full">
              ...
              <Box className="flex justify-around bg-[#0ACF97] p-2 rounded">
                <Typography className="font-bold text-textDark2 dark:text-black text-[18px] mb-1 capitalize text-center">
                  {t(["Count"])}: <span className="dark:text-[#000] font-semibold text-[16px]">15</span>
                </Typography>
                <Typography className="font-bold text-textDark2 dark:text-black text-[18px] mb-1 capitalize text-center">
                  {t(["Amount"])}: <span className=" dark:text-[#000] font-semibold text-[16px]">2000 AZN </span>
                </Typography>
              </Box>
            </Box>
            <Box className="w-full">
          ...
          <Box className="mt-4 py-4 px-6 rounded bg-bgLight dark:bg-bgMain w-full drop-shadow-lg ">
            <Typography className="text-text2 mb-4 text-[0.9rem]">BORCLU MƏNZILLƏR</Typography>
            <Box>
              <TableContainer
