...
const MyInvoices = loadable(
	() =>
		import(/* webpackChunkName: "MyInvoices" */ '../pages/MyInvoices/MyInvoices'),
	{
		fallback: <div>loading...</div>,
	},
);
...
const Tv = loadable(
	() =>
		import(/* webpackChunkName: "Tv" */ '../pages/Managment/CommunalServices/Tv'),
	{
		fallback: <div>loading...</div>,
	},
);
...
const Permission = loadable(
	() =>
		import(/* webpackChunkName: "Permission" */ '../pages/Apartment/Permission'),
	{
		fallback: <div>loading...</div>,
	},
);
...
const Apartments = loadable(
	() =>
		import(/* webpackChunkName: "Apartments" */ '../pages/Apartment/Apartments'),
	{
		fallback: <div>loading...</div>,
	},
);
